...
40:         RollingResistanceLoco = ((LocoRRL1 + LocoRRL2 * Speedkmph + LocoRRL3 * Speedkmph * _
 ...
 Or DDLightEngineLocoType.SelectedItem.Text = "WDP4B" Or DDLightEngineLocoType.SelectedItem.Text = "WDG5" Or DDLightEngineLocoType.SelectedItem.Text = "WDP4D" _
 Or DDLightEngineLocoType.SelectedItem.Text = "WDG4G" Or DDLightEngineLocoType.SelectedItem.Text = "WDG6G" Or DDLightEngineLocoType.SelectedItem.Text = "WAG12" Or DDLightEngineLocoType.SelectedItem.Text = "WDP4D" _
 Or DDLightEngineLocoType.SelectedItem.Text = "BRMSPZ210K" Or DDLightEngineLocoType.SelectedItem.Text = "WDG4D" Or DDLightEngineLocoType.SelectedItem.Text = "SGLOCOEX" Then
        ...
        ElseIf DDLightEngineLocoType.SelectedItem.Text = "WAG9" Or DDLightEngineLocoType.SelectedItem.Text = "WAG9H" Or DDLightEngineLocoType.SelectedItem.Text = "WAP7" Or DDLightEngineLocoType.SelectedItem.Text = "WAP7CONV" Then
            DDLightEngineLocoBrakeBlock.Items.Clear()
            DDLightEngineLocoBrakeBlock.Items.Add("Select")
