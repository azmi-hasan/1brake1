...
180:            Speedkmph = Velocity * 3.6
                ...
                GoTo 190
190:            TotalBPStock = StockBrakePower * StockNumber * .81* StockFriction  * PercentageOperativeCylinder
...
70:         'EBD.Text = TotalDistance
    ...
    Protected Sub DDPassengerLocoType_DataBinding(ByVal sender As Object, ByVal e As System.EventArgs) Handles DDPassengerLocoType.DataBinding
    ...
    Protected Sub DDPassengerLocoType_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles DDPassengerLocoType.SelectedIndexChanged
        If DDPassengerLocoType.SelectedItem.Text = "WDG4" Or DDPassengerLocoType.SelectedItem.Text = "WDP4" Or DDPassengerLocoType.SelectedItem.Text = "WDAP5" Or DDPassengerLocoType.SelectedItem.Text = "WAG12B" Or DDPassengerLocoType.SelectedItem.Text = "WAP5" _
         Or DDPassengerLocoType.SelectedItem.Text = "WDP4B" Or DDPassengerLocoType.SelectedItem.Text = "WDP4D" Or DDPassengerLocoType.SelectedItem.Text = "WDG4G" Or DDPassengerLocoType.SelectedItem.Text = "WAG11" Or DDPassengerLocoType.SelectedItem.Text = "WDG6G" Or DDPassengerLocoType.SelectedItem.Text = "WDP4DD" Or DDPassengerLocoType.SelectedItem.Text = "WDG5" Or DDPassengerLocoType.SelectedItem.Text = "WDG4D" Or DDPassengerLocoType.SelectedItem.Text = "WDAP5" Then
        ...
        ElseIf DDPassengerLocoType.SelectedItem.Text = "WAG9" Or DDPassengerLocoType.SelectedItem.Text = "WAG9H" Or DDPassengerLocoType.SelectedItem.Text = "WAP7" Or DDPassengerLocoType.SelectedItem.Text = "WAP7CONV" Then
            DDPassengerLocoBrakeBlock.Items.Clear()
            DDPassengerLocoBrakeBlock.Items.Add("Select")
